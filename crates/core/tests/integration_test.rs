...
#![expect(
    deprecated,
    reason = "ADR-008: integration tests exercise the workspace path-dep plow_core::analyze* surface; the deprecation warning targets external crates.io consumers"
)]
