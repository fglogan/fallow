...
mod tests {
    ...
    #[test]
    fn untested_file_actions_use_relative_display_path() {
        let root = Path::new("/repo");
        let finding = UntestedFileFinding::with_actions(
            UntestedFile {
                path: PathBuf::from("/repo/src/api.ts"),
    ...
    #[test]
    fn empty_coverage_gaps_reports_empty() {
