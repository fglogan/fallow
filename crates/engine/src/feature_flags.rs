...
pub fn extract_flags_from_source(
    ...
    plow_extract::flags::extract_flags_from_source(
        source,
        path,
        extra_sdk_patterns,
        extra_env_prefixes,
