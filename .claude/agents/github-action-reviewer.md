...
Review changes to plow's GitHub Action. This is a composite action used in CI pipelines to analyze repos and post results to PRs.
...
- `action/scripts/analyze.sh` (run plow)
...
- Plow CLI behavior (review the action layer, not the tool)
