...
Inline review comments target the current PR file state (`side: RIGHT`). Findings on deleted lines are not modeled yet; plow's diagnostics are current-state oriented in normal use.
